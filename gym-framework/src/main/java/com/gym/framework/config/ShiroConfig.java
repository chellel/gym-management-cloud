...
import com.gym.common.utils.spring.SpringUtils;
import com.gym.framework.shiro.realm.UserRealm;
import com.gym.framework.shiro.rememberMe.CustomCookieRememberMeManager;
import com.gym.framework.shiro.session.OnlineSessionDAO;
import com.gym.framework.shiro.session.OnlineSessionFactory;
import com.gym.framework.shiro.web.CustomShiroFilterFactoryBean;
import com.gym.framework.shiro.web.filter.LogoutFilter;
import com.gym.framework.shiro.web.filter.captcha.CaptchaValidateFilter;
import com.gym.framework.shiro.web.filter.csrf.CsrfValidateFilter;
import com.gym.framework.shiro.web.filter.kickout.KickoutSessionFilter;
import com.gym.framework.shiro.web.filter.online.OnlineSessionFilter;
import com.gym.framework.shiro.web.filter.sync.SyncOnlineSessionFilter;
import com.gym.framework.shiro.web.session.OnlineWebSessionManager;
import com.gym.framework.shiro.web.session.SpringSessionValidationScheduler;
